...
\section{Peat decomposition rate differences}
In order to limit GHG emissions from peat decomposition in the Netherlands, it is most useful to apply mitigation measures in places where the highest peat decomposition rates can be found. Peat decomposition rates are higher for soils with higher soil organic carbon content. Moreover, presence of clay and sand layers decrease peat decomposition rates. 
